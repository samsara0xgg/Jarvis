...
- verifier fixes — 4db6506 (16be3a9, 383508c) — hold opens on the pause alone (short first sentence no longer merges; three.wav live = 2 utterances), phase writes locked, decode failure degrades, §4.1 vocabulary (`semantic_complete`); live one.wav=1 / two.wav=2 / three.wav=2; harness+replay 31 passed, regression trio 88 passed, full suite 746 passed.
