...
Learn how to get started with GPT-Live, configure delegation, and prompt the model.
...
- `/llms.txt` — "llms.txt"
- `/api/docs/guides/live` — "get started with GPT-Live"
- `/api/docs/guides/live-delegation` — "configure delegation"
- `/api/docs/guides/live-prompting` — "prompt the model"
