...
- `src/main.tsx`: mock text-send/reply timers, inline notification reply timer,
  ...
  The UI starts in non-Live mode; clicking the disc enters Live. Closing Live
  returns to the disc without hiding or clearing existing results. Remove or gate mock timers
